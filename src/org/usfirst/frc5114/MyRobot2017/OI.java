...
public class OI {
    ...
    public OI() {
    	...
    	//Robot Controls Controller
    	controlGamePad = new Joystick(3);
        // lift = new JoystickButton(gamePad, );
        lower = new JoystickButton(controlGamePad, 1);
        load = new JoystickButton(controlGamePad, 5);
        launch = new JoystickButton(controlGamePad, 6);
